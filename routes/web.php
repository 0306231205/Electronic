...
use App\Http\Middleware\QuayLaiTrangChuNeuDaDangNhap;
...
Route::middleware([IsLogin::class, IsAdmin::class])->group(function () {
    Route::get('/admin', [AdminController::class, 'LoadAdmin'])->name('admin.index');
...
Route::get('/middle', function () {})->middleware(ResultToken::class);
